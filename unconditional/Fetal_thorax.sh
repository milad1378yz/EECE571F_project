...
#SBATCH --output=out-Fetal_thorax.txt         
#SBATCH --error=error-Fetal_thorax.txt           
...
python train_unconditional.py --class_ultra "Fetal thorax" --num_epochs 400