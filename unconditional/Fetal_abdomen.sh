...
#SBATCH --output=out-Fetal_abdomen.txt         
#SBATCH --error=error-Fetal_abdomen.txt           
...
python train_unconditional.py --class_ultra "Fetal abdomen" --num_epochs 400